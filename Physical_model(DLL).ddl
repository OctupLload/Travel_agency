...
CREATE UNIQUE INDEX idx_customer_id ON
    pass_cust (
        customer_id
    ASC );
...
CREATE UNIQUE INDEX idx_treaties_customer_id ON
    treaties (
        customer_id
    ASC );

CREATE UNIQUE INDEX idx_treaties_employee_id ON
    treaties (
        employee_id
    ASC );

CREATE UNIQUE INDEX idx_treaties_tour_id ON
    treaties (
        tour_id
    ASC );

CREATE UNIQUE INDEX idx_treaties_ticket_id ON
    treaties (
        ticket_id
    ASC );
