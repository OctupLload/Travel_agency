...
COMMENT ON COLUMN flights.airlines_airline_id IS
    'Airline ID.';

CREATE INDEX idx_flights ON
    flights (
        airlines_airline_id
    ASC );
...
COMMENT ON COLUMN pass_cust.customers_customer_id IS
    'Customer ID.';

COMMENT ON COLUMN pass_cust.passports_passport_id IS
    'Passport ID.';

CREATE INDEX idx_pass_cust ON
    pass_cust (
...
ALTER TABLE pass_cust ADD CONSTRAINT "PK_pass-cust" PRIMARY KEY ( customers_customer_id,
                                                                  passports_passport_id );
...
COMMENT ON COLUMN staff.positions_position_id IS
    'Position ID.';

CREATE INDEX idx_staff ON
    staff (
        positions_position_id
    ASC );
...
COMMENT ON COLUMN tickets.flights_flight_id IS
    'Flight ID.';

CREATE INDEX idx_tickets ON
    tickets (
        flights_flight_id
    ASC );
...
CREATE TABLE tours (
    ...
    tr_operators_operator_id INTEGER NOT NULL,
...
COMMENT ON COLUMN tours.tr_operators_operator_id IS
    'Operator ID.';

COMMENT ON COLUMN tours.hotels_hotel_id IS
    'Hotel ID.';

CREATE INDEX idx_tours ON
    tours (
        tr_operators_operator_id
    ASC,
        hotels_hotel_id
    ASC );
...
ALTER TABLE tr_operators ADD CONSTRAINT pk_t_operators PRIMARY KEY ( operator_id );
...
COMMENT ON COLUMN treaties.customers_customer_id IS
    'Customer ID.';

COMMENT ON COLUMN treaties.staff_employee_id IS
    'Employee ID.';

COMMENT ON COLUMN treaties.tours_tour_id IS
    'Tour ID.';

COMMENT ON COLUMN treaties.tickets_ticket_id IS
    'Ticket ID.';

CREATE INDEX idx_treaties ON
    treaties (
        customers_customer_id
    ASC,
        staff_employee_id
...
ALTER TABLE flights
    ADD CONSTRAINT fk_flights_airlines FOREIGN KEY ( airlines_airline_id )
        REFERENCES airlines ( airline_id );

ALTER TABLE pass_cust
    ADD CONSTRAINT fk_pass_cust_customers FOREIGN KEY ( customers_customer_id )
        REFERENCES customers ( customer_id );

ALTER TABLE pass_cust
    ADD CONSTRAINT fk_pass_cust_passports FOREIGN KEY ( passports_passport_id )
        REFERENCES passports ( passport_id );

ALTER TABLE staff
    ADD CONSTRAINT fk_staff_positions FOREIGN KEY ( positions_position_id )
        REFERENCES positions ( position_id );

ALTER TABLE tickets
    ADD CONSTRAINT fk_tickets_flights FOREIGN KEY ( flights_flight_id )
        REFERENCES flights ( flight_id );

ALTER TABLE tours
    ADD CONSTRAINT fk_tours_hotels FOREIGN KEY ( hotels_hotel_id )
        REFERENCES hotels ( hotel_id );

ALTER TABLE tours
    ADD CONSTRAINT fk_tours_tr_operators FOREIGN KEY ( tr_operators_operator_id )
        REFERENCES tr_operators ( operator_id );

ALTER TABLE treaties
    ADD CONSTRAINT fk_treaties_customers FOREIGN KEY ( customers_customer_id )
        REFERENCES customers ( customer_id );

ALTER TABLE treaties
    ADD CONSTRAINT fk_treaties_staff FOREIGN KEY ( staff_employee_id )
        REFERENCES staff ( employee_id );

ALTER TABLE treaties
    ADD CONSTRAINT fk_treaties_tickets FOREIGN KEY ( tickets_ticket_id )
        REFERENCES tickets ( ticket_id );

ALTER TABLE treaties
    ADD CONSTRAINT fk_treaties_tours FOREIGN KEY ( tours_tour_id )
